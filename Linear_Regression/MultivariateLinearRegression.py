...
class MultivariateLinearRegression:
    ...
    def normalize(self, data):
        ...
        for i in range(len(data[0])):
            ini_data = [data[j, i] for j in range(len(data))]
    ...
    def cost_function(self):
        ...
        损失计算方法
        """
        delta = MultivariateLinearRegression.hypothesis(
    ...
    def predict(self, data, labels, theta):
        ...
        predictions = MultivariateLinearRegression.hypothesis(
            data_process, theta)
    ...
    def gradient_step(self):
        ...
        """
        prediction = MultivariateLinearRegression.hypothesis(
